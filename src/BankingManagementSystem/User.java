...
public class User {
        ...
        public void register(){ // This is Register Function
            scanner.nextLine();
        ...
        public String login(){  //This is Login Function
            scanner.nextLine();
            System.out.print("Email: ");
            String email = scanner.nextLine();
            System.out.print("Password: ");
    ...
    public boolean user_exit(String email){  //This is User Exit or Not Function
